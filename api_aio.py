    ...
    with conn as connection:
        sql = f"""
            SELECT
                ...
                code_parent,
                libelle_geo,
                (COALESCE(SUM(nb_ventes_maison), 0) + COALESCE(SUM(nb_ventes_appartement), 0)) AS nb_mutations_appart_maison_5ans,
                ...
                CASE
                    ...
                    ELSE (COALESCE(SUM(nb_ventes_maison * moy_prix_m2_maison), 0) + COALESCE(SUM(nb_ventes_appartement * moy_prix_m2_appartement), 0)) / (COALESCE(SUM(nb_ventes_maison), 0) + COALESCE(SUM(nb_ventes_appartement), 0))
